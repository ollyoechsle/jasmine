 ...
 * @version 1.0
 */
public class IntensityStdDev extends Terminal {
    ...
    public double execute(DataStack data) {
        ...
        data.value = ((ExtraShapeData) data.getData()).getIntensityStatistic(data.getImage(), StatisticsSolver.STANDARD_DEVIATION);
    ...
    public String toJava() {
        return "shape.getIntensityStatistic(image, ac.essex.ooechs.imaging.commons.StatisticsSolver.StatisticsSolver.STANDARD_DEVIATION)";
    }
