 ...
 * @version 1.0
 */
public class BalanceXRightVariance extends Terminal {
    ...
    public double execute(DataStack data) {
        ...
        data.value = ((ExtraShapeData) data.getData()).getBalanceXRightVariance();
        return debugger == null? data.value : debugger.record(data.value);
    }

    public String toJava() {
        return "shape.getBalanceXRightVariance()";
    }
