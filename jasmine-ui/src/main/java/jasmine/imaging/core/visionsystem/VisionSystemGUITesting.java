...
public class VisionSystemGUITesting extends JFrame implements VisionSystemListener, ActionListener {
    ...
    public VisionSystemGUITesting(Jasmine j, VisionSystem vs) {
