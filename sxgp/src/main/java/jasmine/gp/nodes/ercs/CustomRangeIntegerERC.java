 ...
 * @version 1.0
 */
public class CustomRangeIntegerERC extends BasicERC {

    private int min, max;

    public CustomRangeIntegerERC(int min, int max) {
        this.min = min;
        this.max = max;
        setValue(initialise());
    }
    ...
    public int[] getReturnTypes() {
        return new int[]{NodeConstraints.NUMBER, NodeConstraints.INTEGER};
    }
