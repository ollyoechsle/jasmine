...
import jasmine.imaging.commons.VarianceThresholder;
 ...
 * @version 1.0
 */
public class VarianceThreshold extends PCM {
    ...
    public VarianceThreshold(int threshold, double MAX, double MIN, int class0, int class1) {
    ...
    public void calculateThresholds() {
        ...
        VarianceThresholder t = new VarianceThresholder(numSlots);
    ...
    public String toJava() {
        return "new VarianceThreshold(" + threshold + ", " + MAX + ", " + MIN + ", " + class0 + ", " + class1 + ")";
    }
}
